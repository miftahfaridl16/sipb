...
<head>
  ...
  <title>Rush Apps | Dashboard</title>
    ...
    <section class="content">
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><?php echo $jmlpesan; ?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><?php echo $jmlkirim; ?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><?php foreach($totals as $t){ echo number_format($t->total, 0,',','.'); } ?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><?php echo $jmlpel; ?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
      ...
      <div class="box box-info">
        <div class="box-header with-border">
          <h3 class="box-title">5 pesanan terakhir</h3>
        ...
        <div class="box-body">
          <div class="table-responsive">
            <table class="table no-margin">
              ...
              ?>
              <tr>
                <td><?php echo $t->no_resi; ?></td>
                <td><?php echo $t->paket_jenis; ?></td>
                <td><?php echo $t->pelanggan_nama; ?></td>
                <td><?php echo '<span class="label label-warning">'.$t->status.'</span>'; ?></td>
              </tr>
              <?php
                  }
              ?>
