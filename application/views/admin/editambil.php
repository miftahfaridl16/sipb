      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?php echo site_url('layanan'); ?>"><i class="fa fa-gift"></i> Layanan</a></li>
            <li><a href="<?php echo site_url('harga'); ?>"><i class="fa fa-gift"></i> Harga</a></li>
          </ul>
        </li>
        <!-- Transaksi Menu -->
        <li class="treeview">
  ...
  <div class="content-wrapper">
    ...
    <div class="col-sm-7">
      <div class="box box-info">
        ...
        <!-- /.box-header -->
        <form role="form" action="<?php echo site_url('pengambilan/updateambil'); ?>" method="post">
        <div class="box-body">
          <?php
            foreach($edit as $e){
              $id = $e->ambil_id;
          ...
          <div class="form-group">
            ...
            <select name="st" class="form-control">
              ...
              <option value="PROSES AMBIL">PROSES AMBIL</option>
            </select>
          </div>
