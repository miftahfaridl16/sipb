    ...
    <div class="col-sm-7">
      <div class="box box-info">
        <div class="box-header with-border">
          <h3 class="box-title">Form Edit Harga</h3>
        ...
        <!-- /.box-header -->
        <form role="form" action="<?php echo site_url('harga/updateharga'); ?>" method="post">
        <div class="box-body">
          <?php
            foreach($edith as $e){
              $id = $e->harga_id;
          ...
          <div class="form-group">
            ...
            <input name="hg" type="text" class="form-control" value="<?php echo $hg; ?>">
          </div>

          <div class="form-group">
            <label>Harga Lebih</label>
            <input name="hl" type="text" class="form-control" value="<?php echo $hl; ?>">
          </div>

          <div class="form-group">
            <label>Layanan</label>
            <select name="ln" class="form-control">
              <option value="<?php echo $iln; ?>"><?php echo $ln; ?></option>
              <?php
                foreach($layanan as $l){
              ?>
                <option value="<?php echo $l->layanan_id; ?>"><?php echo $l->layanan_nama; ?> | <?php echo $l->paket_jenis; ?> | <?php echo $l->kota_nama; ?></option>
              <?php
                }
              ?>
              <option></option>
