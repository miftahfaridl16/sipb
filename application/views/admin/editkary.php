      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="#"><i class="fa fa-user"></i> Kurir</a></li>
  ...
  <div class="content-wrapper">
    ...
    <div class="col-sm-7">
      <div class="box box-info">
        ...
        <!-- /.box-header -->
        <form role="form" action="<?php echo site_url('karyawan/updatekary'); ?>" method="post">
        <div class="box-body">
          ...
          <div class="form-group">
            <label>Alamat</label>
            <input name="alm" type="text" class="form-control" value="<?php echo $al; ?>">
          </div>
