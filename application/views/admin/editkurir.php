      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="#"><i class="fa fa-user-plus"></i> Pelanggan</a></li>
  ...
  <div class="content-wrapper">
    ...
    <div class="col-sm-7">
      <div class="box box-info">
        ...
        <!-- /.box-header -->
        <form role="form" action="<?php echo site_url('kurir/updatekurir'); ?>" method="post">
        <div class="box-body">
          ...
          <div class="form-group">
            <label>Wilayah</label>
            <select name="wl" class="form-control">
              <option value="<?php echo $wl; ?>" selected><?php echo $wl; ?></option>
            </select>
          </div>

          <div class="form-group">
            <label>User ID</label>
            <input name="us" type="text" class="form-control" value="<?php echo $us; ?>">
          </div>

          <div class="form-group">
            <label>Password</label>
            <input name="pw" type="password" class="form-control" value="<?php echo $pw; ?>">
          </div>
