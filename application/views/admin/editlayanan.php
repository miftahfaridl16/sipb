  ...
  <div class="content-wrapper">
    ...
    <div class="col-sm-7">
      <div class="box box-info">
        ...
        <form role="form" action="<?php echo site_url('layanan/updatelayanan'); ?>" method="post">
        <div class="box-body">
          
          <div class="form-group">
            <label>Layanan</label>
            <input name="id" type="hidden" class="form-control" value="<?php echo $id; ?>">
            <input name="ly" type="text" class="form-control" value="<?php echo $nm; ?>">
          </div>
          <div class="form-group">
            <label>Estimasi</label>
            <input name="et" type="text" class="form-control" value="<?php echo $es; ?>">
          </div>
          <div class="form-group">
            <label>Paket</label>
            <select name="pt" class="form-control">
              <option value="<?php echo $ip; ?>" selected><?php echo $np; ?></option>
              <?php
                foreach($paket as $t){
              ?>
                <option value="<?php echo $t->paket_id; ?>"><?php echo $t->paket_jenis; ?> (<?php echo $t->kota_nama; ?>)</option>
              <?php
                }
              ?>
            </select>
