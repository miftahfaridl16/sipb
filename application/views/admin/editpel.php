...
<div class="wrapper">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="#"><i class="fa fa-flag-checkered"></i> Kota</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-group"></i> Pelanggan</a></li>
      </ol>
    </section>
    ...
    <div class="col-sm-7">
      <div class="box box-info">
        ...
        <?php
          ...
          // Edit Combobox Data Pelanggan

          foreach($edit as $e){

            $id = $e->pelanggan_id;
            $nm = $e->pelanggan_nama;
            $al = $e->pelanggan_alamat;
            $kt = $e->pelanggan_kota;
            $ki = $e->kota_id;
            $kn = $e->kota_nama;
            $hp = $e->pelanggan_hp;
            $em = $e->pelanggan_email;
            $us = $e->pelanggan_usr;
            $pw = $e->pelanggan_psw;
        ...
        <form role="form" action="<?php echo site_url('pelanggan/updatepel'); ?>" method="post">
        <div class="box-body">
          <div class="form-group">
            <label>Nama Lengkap</label>
            <input type="hidden" name="id" value="<?php echo $id; ?>">
            <input name="nm" type="text" class="form-control" value="<?php echo $nm; ?>">
          </div>

          <div class="form-group">
            <label>Alamat</label>
            <input name="al" type="text" class="form-control" value="<?php echo $al; ?>">
          </div>

          <div class="form-group">
            <label>Kota</label>
            <select name="kt" class="form-control">
              <option value="<?php echo $kt; ?>" selected><?php echo $kn; ?></option>
              <?php
                foreach($kota as $k){
              ?>
                <option value="<?php echo $k->kota_id; ?>"><?php echo $k->kota_nama; ?></option>
              <?php
                }
              ?>
            </select>
          ...
          <div class="form-group">
            <label>Telp</label>
            <input name="hp" type="text" class="form-control" value="<?php echo $hp; ?>">
          </div>
          <div class="form-group">
            <label>Email</label>
            <input name="em" type="text" class="form-control" value="<?php echo $em; ?>">
          </div>

          <div class="form-group">
            <label>User ID</label>
            <input name="usr" type="text" class="form-control" value="<?php echo $us; ?>">
          </div>

          <div class="form-group">
            <label>Password</label>
            <input name="psw" type="password" class="form-control" value="<?php echo $pw; ?>">
          </div>
