    ...
    <div class="col-sm-7">
      <div class="box box-info">
        <div class="box-header with-border">
          <h3 class="box-title">Form Edit Pemesanan</h3>
        ...
        <!-- /.box-header -->
        <form role="form" action="<?php echo site_url('pemesanan/updatepesan'); ?>" method="post">
        <div class="box-body">
          <?php
            foreach($edit as $e){
              $id = $e->no_resi;
          ...
          <div class="form-group">
            ...
            <select name="st" class="form-control">
              ...
              <option value="PROSES AMBIL">PROSES KIRIM</option>
            </select>
          </div>
