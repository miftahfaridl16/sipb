...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-group"></i> Harga</a></li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="box box-info">
        <div class="box-header with-border">
          <h3 class="box-title"><a href="<?php echo site_url('harga/tambahharga'); ?>" class="btn btn-info">Tambah Data</a></h3>
        ...
        <div class="box-body">
          <table id="example1" class="table table-bordered table-striped">
                ...
                ?>
                <tr>
                  <td><?php echo $h->harga_id; ?></td>
                  <td><?php echo $h->harga; ?></td>
                  <td><?php echo $h->layanan_nama; ?> | <?php echo $h->paket_jenis; ?> | <?php echo $h->kota_nama; ?></td>
                  <td>
                    <?php echo anchor(base_url().'harga/editharga/'.$h->harga_id, '<button class="btn btn-warning btn-sm">Edit</button>'); ?>
                    <?php echo anchor('harga/hapusharga/'.$h->harga_id, '<button class="btn btn-danger btn-sm">Hapus</button>'); ?>
                  </td>
                </tr>
                <?php
                  }
