...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-group"></i> Karyawan</a></li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="box box-info">
        <div class="box-header with-border">
          <h3 class="box-title"><a href="<?php echo site_url('karyawan/tambahkary'); ?>" class="btn btn-info">Tambah Data</a></h3>
        ...
        <div class="box-body">
          <table id="example1" class="table table-bordered table-striped">
                ...
                ?>
                <tr>
                  <td><?php echo $k->user_nama; ?></td>
                  <td><?php echo $k->user_lkp; ?></td>
                  <td><?php echo $k->user_hp; ?></td>
                </tr>
                <?php
                  }
                ?>
