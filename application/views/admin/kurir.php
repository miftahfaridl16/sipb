...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-group"></i> Kurir</a></li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="box box-info">
        <div class="box-header with-border">
          <h3 class="box-title"><a href="<?php echo site_url('kurir/tambahkurir'); ?>" class="btn btn-info">Tambah Data</a></h3>
        ...
        <div class="box-body">
          <table id="example1" class="table table-bordered table-striped">
                ...
                ?>
                <tr>
                  <td><?php echo $kr->kurir_nama; ?></td>
                  <td><?php echo $kr->kurir_alamat; ?></td>
                  <td><?php echo $kr->kurir_telp; ?></td>
                  <td><?php echo $kr->kurir_wilayah; ?></td>
                  <td><?php echo $kr->kurir_usr; ?></td>
                  <td>
                    <?php echo anchor(base_url().'kurir/editkurir/'.$kr->kurir_id, '<button class="btn btn-warning btn-sm">Edit</button>'); ?>
                    <?php echo anchor('kurir/hapuskurir/'.$kr->kurir_id, '<button class="btn btn-danger btn-sm">Hapus</button>'); ?>
                  </td>
                </tr>
                <?php
                  }
