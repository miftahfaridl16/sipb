...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-group"></i> Omset Pengiriman</a></li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="box box-info">
        <div class="box-header with-border">
          <h3 class="box-title">
            <form method="post" action="<?php echo base_url();?>omset/cetaklaporan" class="form-inline">
...
<script type="text/javascript">
    ...
    $('#charts').highcharts({
        title: {
            text: 'Omset Pengiriman per Bulan',
            x: -20 //center
        },
        subtitle: {
            text: 'rush courier',
