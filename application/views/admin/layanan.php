...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-group"></i> Layanan</a></li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="box box-info">
        <div class="box-header with-border">
          <h3 class="box-title"><a href="<?php echo site_url('layanan/tambahlayanan'); ?>" class="btn btn-info">Tambah Data</a></h3>
        ...
        <div class="box-body">
          <table id="example1" class="table table-bordered table-striped">
                ...
                ?>
                <tr>
                  <td><?php echo $y->layanan_id; ?></td>
                  <td><?php echo $y->layanan_nama; ?></td>
                  <td><?php echo $y->layanan_estimasi; ?></td>
                  <td><?php echo $y->paket_jenis; ?></td>
                  <td>
                    <?php echo anchor(base_url().'layanan/editlayanan/'.$y->layanan_id, '<button class="btn btn-warning btn-sm">Edit</button>'); ?>
                    <?php echo anchor('layanan/hapuslayanan/'.$y->layanan_id, '<button class="btn btn-danger btn-sm">Hapus</button>'); ?>
                  </td>
                </tr>
                <?php
                  }
