    ...
    <section class="content">
      ...
      <div class="box box-info">
        <div class="box-header with-border">
          <h3 class="box-title"><a href="<?php echo site_url('paket/tambahpaket'); ?>" class="btn btn-info">Tambah Data</a></h3>
        ...
        <div class="box-body">
          <table id="example1" class="table table-bordered table-striped">
                ...
                ?>
                <tr>
                  <td><?php echo $g->paket_id; ?></td>
                  <td><?php echo $g->paket_jenis; ?></td>
                  <td><?php echo $g->kota_nama; ?></td>
                  <td>
                    <?php echo anchor(base_url().'paket/editpaket/'.$g->paket_id, '<button class="btn btn-warning btn-sm">Edit</button>'); ?>
                    <?php echo anchor('paket/hapuspaket/'.$g->paket_id, '<button class="btn btn-danger btn-sm">Hapus</button>'); ?>
                  </td>
                </tr>
                <?php
                  }
