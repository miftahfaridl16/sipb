...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-group"></i> Pemesanan</a></li>
      </ol>
    </section>
        ...
        <div class="box-body">
          <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td><?php echo $s->pelanggan_nama; ?></td>
                  <td><?php echo $s->penerima_nama; ?></td>
                  <td><?php echo $s->penerima_alamat; ?></td>
                  <td><?php echo $s->kota_nama ?></td>
                  <td><?php echo $s->paket_jenis; ?></td>
                  <td><?php echo $s->berat; ?></td>
                  <td><?php echo $s->biaya; ?></td>
                  <td><?php echo $s->total_biaya; ?></td>
                  <td><?php echo $s->tgl_pesan; ?></td>
                  <td><?php echo $s->tgl_kirim; ?></td>
                  <td><?php echo $s->status; ?></td>
                  <td>
                    <?php echo anchor(base_url().'pemesanan/editstatus/'.$s->no_resi, '<button class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></button>'); ?>
                    <?php echo anchor(base_url().'pemesanan/cetak/'.$s->no_resi, '<button class="btn btn-info btn-sm"><i class="fa fa-print"></i></button>', array('target'=>'blank')); ?>
                  </td>
                </tr>
