...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-group"></i> Pengambilan</a></li>
      </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="box-body">
          <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td><?php echo $p->penerima_nama; ?></td>
                  <td><?php echo $p->penerima_alamat; ?></td>
                  <td><?php echo $p->kota_nama; ?></td>
      ...
      <div class="box box-info">
        <div class="box-header with-border">
          <h3 class="box-title"><a href="<?php echo site_url('pengambilan/tambahambil'); ?>" class="btn btn-info">Tambah Jadwal</a></h3>
        ...
        <div class="box-body">
          <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    ?>
                <tr>
                  <td><?php echo $a->ambil_id; ?></td>
                  <td><?php echo $a->no_resi; ?></td>
                  <td><?php echo $a->penerima_nama; ?></td>
                  <td><?php echo $a->penerima_alamat; ?></td>
                  <td><?php echo $a->ambil_tgl; ?></td>
                  <td><?php echo $a->kurir_nama; ?></td>
                  <td><?php echo $a->ambil_status; ?></td>

                  <td>
                    <?php echo anchor(base_url().'pengambilan/editambil/'.$a->ambil_id, '<button class="btn btn-warning btn-sm">Edit</button>'); ?>
                    <?php //echo anchor(base_url().'pengambilan/hapusambil/'.$a->ambil_id, '<button class="btn btn-danger btn-sm">Hapus</button>'); ?>
                  </td>
                </tr>
