...
<div class="wrapper">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?php echo site_url(); ?>layanan"><i class="fa fa-archive"></i> Layanan</a></li>
            <li><a href="<?php echo site_url('harga'); ?>"><i class="fa fa-money"></i> Harga</a></li>
          </ul>
        </li>
        <!-- Transaksi Menu -->
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo site_url('pemesanan'); ?>"><i class="fa fa-arrow-circle-right"></i> Pemesanan</a></li>
            <li><a href="<?php echo site_url('pengambilan'); ?>"><i class="fa fa-arrow-circle-left"></i> Pengambilan</a></li>
            <li><a href="<?php echo site_url('pengiriman'); ?>""><i class="fa fa-arrow-circle-right"></i> Pengiriman</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo site_url('omset'); ?>"><i class="fa fa-bar-chart"></i> Omset Pengiriman</a></li>
          </ul>
        </li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-group"></i> Pengiriman</a></li>
      </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="box-body">
          <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td><?php echo $a->tgl_kirim; ?></td>
                  <td><?php echo $a->ambil_status; ?></td>
                </tr>
      ...
      <div class="box box-info">
        <div class="box-header with-border">
          <h3 class="box-title"><a href="<?php echo site_url('pengiriman/tambahkirim'); ?>" class="btn btn-info">Tambah Jadwal</a></h3>
        ...
        <div class="box-body">
          <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    ?>
                <tr>
                  <td><?php echo $s->kirim_id; ?></td>
                  <td><?php echo $s->no_resi; ?></td>
                  <td><?php echo $s->penerima_nama; ?></td>
                  <td><?php echo $s->penerima_alamat; ?></td>
                  <td><?php echo $s->kirim_tgl; ?></td>
                  <td><?php echo $s->kurir_nama; ?></td>
                  <td><?php echo $s->kirim_status; ?></td>
                  <td>
                    <?php echo anchor(base_url().'pengiriman/editkirim/'.$s->kirim_id, '<button class="btn btn-warning btn-sm">Edit</button>'); ?>
                    <?php //echo anchor(base_url().'pengiriman/hapusambil/'.$s->kirim_id, '<button class="btn btn-info btn-sm">Resi</button>'); ?>
                  </td>
                </tr>
