    ...
    <div class="col-sm-7">
      <div class="box box-info">
        <div class="box-header with-border">
          <h3 class="box-title">Tambah Jadwal Pengambilan</h3>
        ...
        <!-- /.box-header -->
        <form action="<?php echo site_url('pengambilan/simpanambil'); ?>" method="post" role="form">
        <?php 
        ...
        <div class="box-body">
          ...
          <div class="form-group">
            ...
            <input name="tgl_ambil" type="text" class="form-control" id="datepicker" placeholder="tanggal ambil">
          </div>
            ...
            <select name="kurir" class="form-control">
              ...
              <?php
                foreach ($kurir as $k) {
                  # code...
              ?>
                <option value="<?php echo $k->kurir_id; ?>"><?php echo $k->kurir_nama; ?></option>
              <?php
                }
              ?>
            </select>
          ...
          <div class="form-group">
            ...
            <select name="sts" class="form-control">
              <option value="">--Pilih--</option>
              <option value="on proses">PESAN</option>
              <option value="complete">PROSES AMBIL</option>
              <option value="complete">TERAMBIL</option>
            </select>
          </div>

          <div class="form-group">
            <label>Prioritas</label>
            <input name="pr" type="text" class="form-control" placeholder="prioritas..">
          </div>
