    ...
    <div class="col-sm-7">
      <div class="box box-info">
        <div class="box-header with-border">
          <h3 class="box-title">Form Tambah Harga</h3>
        ...
        <!-- /.box-header -->
        <form action="<?php echo site_url('harga/simpanharga'); ?>" method="post" role="form">
        <?php 
        ...
        <div class="box-body">
          <div class="form-group">
            <label>Harga</label>
            <input name="hg" type="text" class="form-control" placeholder="harga..">
          </div>

          <div class="form-group">
            <label>Harga Lebih</label>
            <input name="hl" type="text" class="form-control" placeholder="harga lebih..">
          </div>
