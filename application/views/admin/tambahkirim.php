    ...
    <div class="col-sm-7">
      <div class="box box-info">
        <div class="box-header with-border">
          <h3 class="box-title">Tambah Jadwal Pengiriman</h3>
        ...
        <!-- /.box-header -->
        <form action="<?php echo site_url('pengiriman/simpankirim'); ?>" method="post" role="form">
        <?php 
        ...
        <div class="box-body">
          ...
          <div class="form-group">
            ...
            <input name="tgl_kirim" type="text" class="form-control" id="datepicker" placeholder="tanggal kirim..">
          </div>
            ...
            <select name="kurir" class="form-control">
              ...
              <?php
                foreach ($kurir as $k) {
                  # code...
              ?>
                <option value="<?php echo $k->kurir_id; ?>"><?php echo $k->kurir_nama; ?> (<?php echo $k->kurir_wilayah; ?>)</option>
              <?php
                }
              ?>
            </select>
