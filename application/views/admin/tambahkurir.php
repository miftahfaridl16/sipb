  ...
  <div class="content-wrapper">
    ...
    <div class="col-sm-7">
      <div class="box box-info">
        ...
        <!-- /.box-header -->
        <form action="<?php echo site_url('kurir/simpankurir'); ?>" method="post" role="form">
        <?php 
        ...
        <div class="box-body">
          <div class="form-group">
            ...
            <input name="nama" type="text" class="form-control" placeholder="nama kurir..">
          </div>
          <div class="form-group">
            <label>Alamat</label>
          ...
          <div class="form-group">
            ...
            <select name="kota" class="form-control">
              <?php
                foreach($kota as $c){
              ?>
                <option value="<?php echo $c->kota_id; ?>"><?php echo $c->kota_nama; ?></option>
              <?php
                }
              ?>
            </select>
          ...
          <div class="form-group">
            <label>User ID</label>
            <input name="usr" type="text" class="form-control" placeholder="user..">
          </div>
          <div class="form-group">
