  ...
  <div class="content-wrapper">
    ...
    <div class="col-sm-7">
      <div class="box box-info">
        ...
        <!-- /.box-header -->
        <form action="<?php echo site_url('layanan/simpanlayanan'); ?>" method="post" role="form">
        <?php 
        ...
        <div class="box-body">
          <div class="form-group">
            <label>Layanan</label>
            <input name="ly" type="text" class="form-control" placeholder="nama layanan">
          </div>

          <div class="form-group">
            <label>Estimasi</label>
            <input name="et" type="text" class="form-control" placeholder="estimasi..">
          </div>
            ...
            <select name="paket" class="form-control">
              <?php
                ...
                foreach ($paket as $p) {
                  # code...
              ?>
                <option value="<?php echo $p->paket_id; ?>"><?php echo $p->paket_jenis; ?> (<?php echo $p->kota_nama; ?>)</option>
              <?php
                }
              ?>
            </select>
