  ...
  <div class="content-wrapper">
    ...
    <div class="col-sm-7">
      <div class="box box-info">
        ...
        <!-- /.box-header -->
        <form action="<?php echo site_url('pelanggan/simpanpel'); ?>" method="post" role="form">
        <?php 
        ...
        <div class="box-body">
          <div class="form-group">
            ...
            <input name="nm" type="text" class="form-control" placeholder="nama karyawan..">
          </div>
          <div class="form-group">
            <label>Alamat</label>
            <input name="al" type="text" class="form-control" placeholder="alamat..">
          </div>
          <div class="form-group">
            <label>Kota</label>
          ...
          <div class="form-group">
            <label>Telp</label>
            <input name="hp" type="text" class="form-control" placeholder="telepon..">
          </div>
          <div class="form-group">
            <label>Email</label>
            <input name="em" type="text" class="form-control" placeholder="email..">
          </div>
          <div class="form-group">
            <label>Username ID</label>
            <input name="us" type="text" class="form-control" placeholder="username..">
          </div>
          <div class="form-group">
