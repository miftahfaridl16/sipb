      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?php echo site_url('courier/lihatjadwal'); ?>"><i class="fa fa-calendar-check-o"></i> Lihat Jadwal</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
        <div class="callout callout-info" style="margin-bottom:0!important;">
          ...
          Selamat Datang, Sdr/Sdri &nbsp;&nbsp;<b><?php echo $nama; ?></b> &nbsp;&nbsp;di halaman kurir. Selamat bekerja.
        </div>
    </section>
    <!-- /.content -->
  </div>
