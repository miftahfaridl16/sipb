    ...
    <div class="col-sm-7">
      <div class="box box-info">
        <div class="box-header with-border">
          <h3 class="box-title">Form Edit Pengiriman</h3>
        ...
        <!-- /.box-header -->
        <form role="form" action="<?php echo site_url('courier/updatecourier'); ?>" method="post" enctype="multipart/form-data">
        <div class="box-body">
          <?php
              foreach($kirim as $k){
          ...
          <div class="form-group">
            <label>No Resi</label>
            <input type="text" name="noresi" class="form-control" value="<?php echo $nr; ?>">
          </div>
