  ...
  <div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box-header with-border">
          <h3 class="box-title"><?php echo anchor(base_url().'courier/cetak/'.$id, '<button class="btn btn-warning"><i class="fa fa-print"></i> Cetak</button>'); ?></h3>
        ...
        <div class="box-body">
          <table  class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  ?>
                  <tr>
                    <td><?php echo $j->ambil_prioritas; ?></td>
                    <td><?php echo $j->no_resi; ?></td>
                    <td><?php echo $j->penerima_nama; ?></td>
                    <td><?php echo $j->penerima_alamat; ?></td>
                    <td><?php echo $j->ambil_tgl; ?></td>
                    <td><?php echo $j->ambil_status; ?></td>
                  </tr>
                  <?php
                    }
                  ?>
