...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <form action="<?php echo base_url()?>authc/login" method="post">
      ...
      <div class="row">
        ...
        <!-- /.col -->
        <div class="col-xs-4">
          <button type="submit" class="btn btn-primary btn-block btn-flat">Sign In <span class="glyphicon glyphicon-chevron-right"></span> </button>
        </div>
        <!-- /.col -->
      </div>
    </form>
