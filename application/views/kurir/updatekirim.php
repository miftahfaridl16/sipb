...
<div class="wrapper">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="<?php echo site_url('authc/logout'); ?>" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-book"></i> <span>Kurir</span> <i class="fa fa-angle-left pull-right"></i>
          </a>
          <ul class="treeview-menu">
            <li><a href="<?php echo site_url('courier'); ?>"><i class="fa fa-users"></i> Home</a></li>
            <li><a href="<?php echo site_url('courier/lihatjadwal'); ?>"><i class="fa fa-calendar-check-o"></i> Lihat Jadwal</a>
            </li>
            <li><a href="<?php echo site_url('courier/statusfoto'); ?>"><i class="fa fa-camera"></i> Update Status</a></li>
          </ul>
        </li>
        <!-- Transaksi Menu -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Kurir
        <small>update kirim</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Kurir</a></li>
      </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="box-header with-border">
          <h3 class="box-title">Update Kirim</h3>
        ...
        <div class="box-body">
          <table  class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  ?>
                  <tr>
                    <td><?php echo $u->no_resi; ?></td>
                    <td><?php echo $u->kirim_tgl; ?></td>
                    <td><?php echo $u->kurir_nama; ?></td>
                    <td><?php echo $u->kirim_status; ?></td>
                    <?php if($u->kirim_foto) { ?>
                    <td><img src="<?php echo base_url(); ?>assets/uploads/<?php echo $u->kirim_foto; ?>" width="50" height="50"></td>
                    <?php } else { ?>
                    <td><?php echo $u->kirim_foto; ?></td>
                    <?php } ?>
                    <td><?php echo anchor(base_url().'courier/editcourier/'.$u->kirim_id, '<button class="btn btn-warning btn-sm">Update</button>'); ?></td>
                  </tr>
                  <?php
                    }
                  ?>
