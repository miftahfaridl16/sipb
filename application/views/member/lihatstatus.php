    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo site_url('member/lihatstatus'); ?>"><i class="fa fa-arrow-circle-right"></i> Lihat Status</a></li>
          </ul>
        </li>
        <!-- Transaksi Menu -->
        ...
        <div class="box-body">
          <table  class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td><?php echo $s->layanan_nama; ?></td>
                  <td><small class="label label-warning"><?php echo $s->status; ?></small></td>
                </tr>
                <?php
                  }
                ?>
