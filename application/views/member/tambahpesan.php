            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="<?php echo site_url('authen/logout'); ?>" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-book"></i> <span>Pemesanan</span> <i class="fa fa-angle-left pull-right"></i>
          </a>
          <ul class="treeview-menu">
            <li><a href="<?php echo site_url('member'); ?>"><i class="fa fa-arrow-circle-right"></i> Home</a></li>
            <li><a href="<?php echo site_url('member/tambahorder'); ?>"><i class="fa fa-arrow-circle-right"></i> Form Pemesanan</a></li>
          </ul>
        </li>
        <!-- Transaksi Menu -->
    ...
    <section class="content">
        <div class="row">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form method="post" action="<?php echo site_url('member/simpanorder'); ?>" role="form">
              <?php 
              ...
              <div class="box-body">
                <div class="form-group">
                  <label>No. Resi</label>
                  <input name="noresi" type="text" class="form-control" value="<?php echo $resi; ?>">
                  <input name="idpel" type="hidden" class="form-control" value="<?php echo $idpel; ?>">
                </div>

                <div class="form-group">
                  <label>Tgl. Pesan</label>
                  <input name="tglpsn" type="text" class="form-control" value="<?php echo date('d-m-Y'); ?>">
                </div>
                ...
                <div class="form-group">
                  <label>Telp</label>
                  <input name="tlp" type="text" class="form-control" placeholder="Telepon">
                </div>
                ...
                <div class="form-group">
                  ...
                  <select id="kota" name="kota" class="form-control">
                    ...
                    <?php
                      foreach($kota as $cy){
                    ?>
                      <option value="<?php echo $cy->kota_id; ?>"><?php echo $cy->kota_nama; ?></option>
                    <?php
                      } 
                    ?>
                  </select>
                ...
                <div class="form-group">
                  ...
                  <input id="lebih" name="hrglbh" type="hidden" class="form-control">
                </div>

                <div class="form-group">
                  <label>Estimasi</label>
                  <input id="estimasi" name="estimasi" type="text" class="form-control">
                </div>
...
<script type="text/javascript">
 ...
 $(document).ready(function(){
    ...
    $("#kota").change(function(){
        ...
        $.ajax({
            type:"POST",
            url:"<?php echo base_url(); ?>member/getpaket",
    ...
    $("#paket").change(function(){
      ...
      $.ajax({
        type:"POST",
        url:"<?php echo base_url(); ?>member/ambillayanan",
    ...
    $("#layanan").change(function(){
      ...
      $.ajax({
        type:"POST",
        url:"<?php echo base_url(); ?>member/ambilharga",
